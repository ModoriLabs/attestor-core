...
import {
  ...
  signClaimRequest,
} from "src/avs/utils/tasks"
import {
  createClaimOnAttestor as _createClaimOnAttestor,
...
export async function createClaimOnAvs<N extends ProviderName>({
  ...
  async function completeTask() {
    ...
    const object = JSON.parse(
      rslt.taskCompletedObjectJson
    ) as TaskCompletedEventObject
