...
export const HttpProviderParametersJson = {
  title: "HttpProviderParameters",
  type: "object",
  required: ["url", "method", "responseMatches"],
  properties: {
    url: {
      type: "string",
      format: "url",
    ...
    additionalClientOptions: {
      ...
      properties: {
        supportedProtocolVersions: {
          ...
          minItems: 1,
          uniqueItems: true,
          items: { type: "string", enum: ["TLS1_2", "TLS1_3"] },
        },
      },
    },
    responseMatches: {
...
export const HttpProviderSecretParametersJson = {
