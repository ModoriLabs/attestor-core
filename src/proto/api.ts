...
export function transcriptMessageSenderTypeFromJSON(
  object: any
...
export function transcriptMessageSenderTypeToJSON(
  object: TranscriptMessageSenderType
): string {
  switch (object) {
...
export function serviceSignatureTypeFromJSON(
  object: any
...
export function serviceSignatureTypeToJSON(
  object: ServiceSignatureType
): string {
  switch (object) {
...
export const ClaimContext: MessageFns<ClaimContext> = {
  encode(
    ...
    Object.entries(message.extractedParameters).forEach(([key, value]) => {
      ClaimContext_ExtractedParametersEntry.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          const entry1 = ClaimContext_ExtractedParametersEntry.decode(
            reader,
            reader.uint32()
          )
  ...
  fromJSON(object: any): ClaimContext {
    return {
      extractedParameters: isObject(object.extractedParameters)
        ? Object.entries(object.extractedParameters).reduce<{
            [key: string]: string
          }>((acc, [key, value]) => {
        ...
        : {},
      providerHash: isSet(object.providerHash)
        ? globalThis.String(object.providerHash)
        : "",
    }
  },
  ...
  fromPartial(object: DeepPartial<ClaimContext>): ClaimContext {
    const message = createBaseClaimContext()
    message.extractedParameters = Object.entries(
      object.extractedParameters ?? {}
...
export const ClaimContext_ExtractedParametersEntry: MessageFns<ClaimContext_ExtractedParametersEntry> =
  {
    encode(
      message: ClaimContext_ExtractedParametersEntry,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      if (message.key !== "") {
    ...
    create(
      base?: DeepPartial<ClaimContext_ExtractedParametersEntry>
    ): ClaimContext_ExtractedParametersEntry {
      return ClaimContext_ExtractedParametersEntry.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<ClaimContext_ExtractedParametersEntry>
    ): ClaimContext_ExtractedParametersEntry {
      const message = createBaseClaimContext_ExtractedParametersEntry()
  ...
  fromJSON(object: any): ProviderClaimData {
    return {
      ...
      parameters: isSet(object.parameters)
        ? globalThis.String(object.parameters)
        : "",
      owner: isSet(object.owner) ? globalThis.String(object.owner) : "",
      timestampS: isSet(object.timestampS)
        ? globalThis.Number(object.timestampS)
        : 0,
...
export const CreateTunnelRequest: MessageFns<CreateTunnelRequest> = {
  ...
  fromJSON(object: any): CreateTunnelRequest {
    return {
      ...
      geoLocation: isSet(object.geoLocation)
...
export const DisconnectTunnelRequest: MessageFns<DisconnectTunnelRequest> = {
  ...
  fromPartial(
    object: DeepPartial<DisconnectTunnelRequest>
  ): DisconnectTunnelRequest {
    const message = createBaseDisconnectTunnelRequest()
    message.id = object.id ?? 0
    return message
...
export const TunnelDisconnectEvent: MessageFns<TunnelDisconnectEvent> = {
  ...
  fromPartial(
    object: DeepPartial<TunnelDisconnectEvent>
  ): TunnelDisconnectEvent {
    const message = createBaseTunnelDisconnectEvent()
    message.tunnelId = object.tunnelId ?? 0
    message.error =
...
export const MessageReveal: MessageFns<MessageReveal> = {
  encode(
    ...
    if (message.directReveal !== undefined) {
      MessageReveal_MessageRevealDirect.encode(
        message.directReveal,
        writer.uint32(10).fork()
      ).join()
    }
    if (message.zkReveal !== undefined) {
      MessageReveal_MessageRevealZk.encode(
        message.zkReveal,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.directReveal = MessageReveal_MessageRevealDirect.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 2: {
          ...
          message.zkReveal = MessageReveal_MessageRevealZk.decode(
            reader,
            reader.uint32()
          )
          continue
  ...
  fromJSON(object: any): MessageReveal {
    return {
      directReveal: isSet(object.directReveal)
        ...
        : undefined,
      zkReveal: isSet(object.zkReveal)
        ? MessageReveal_MessageRevealZk.fromJSON(object.zkReveal)
        : undefined,
    }
  },
  ...
  toJSON(message: MessageReveal): unknown {
    const obj: any = {}
    if (message.directReveal !== undefined) {
      obj.directReveal = MessageReveal_MessageRevealDirect.toJSON(
        message.directReveal
      )
    }
    if (message.zkReveal !== undefined) {
  ...
  fromPartial(object: DeepPartial<MessageReveal>): MessageReveal {
    const message = createBaseMessageReveal()
    message.directReveal =
      object.directReveal !== undefined && object.directReveal !== null
        ? MessageReveal_MessageRevealDirect.fromPartial(object.directReveal)
        : undefined
    message.zkReveal =
      object.zkReveal !== undefined && object.zkReveal !== null
...
export const MessageReveal_MessageRevealDirect: MessageFns<MessageReveal_MessageRevealDirect> =
  {
    encode(
      message: MessageReveal_MessageRevealDirect,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
    ...
    fromJSON(object: any): MessageReveal_MessageRevealDirect {
      return {
        ...
        recordNumber: isSet(object.recordNumber)
          ? globalThis.Number(object.recordNumber)
          : 0,
      }
    },
    ...
    create(
      base?: DeepPartial<MessageReveal_MessageRevealDirect>
    ): MessageReveal_MessageRevealDirect {
      return MessageReveal_MessageRevealDirect.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<MessageReveal_MessageRevealDirect>
    ): MessageReveal_MessageRevealDirect {
      const message = createBaseMessageReveal_MessageRevealDirect()
...
export const MessageReveal_MessageRevealZk: MessageFns<MessageReveal_MessageRevealZk> =
  {
    encode(
      message: MessageReveal_MessageRevealZk,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.proofs.push(
              MessageReveal_ZKProof.decode(reader, reader.uint32())
            )
            continue
          }
        }
    ...
    create(
      base?: DeepPartial<MessageReveal_MessageRevealZk>
    ): MessageReveal_MessageRevealZk {
      return MessageReveal_MessageRevealZk.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<MessageReveal_MessageRevealZk>
    ): MessageReveal_MessageRevealZk {
      const message = createBaseMessageReveal_MessageRevealZk()
      message.proofs =
        object.proofs?.map(e => MessageReveal_ZKProof.fromPartial(e)) || []
      return message
    },
  }
...
export const MessageReveal_ZKProof: MessageFns<MessageReveal_ZKProof> = {
  ...
  fromJSON(object: any): MessageReveal_ZKProof {
    return {
      proofJson: isSet(object.proofJson)
        ? globalThis.String(object.proofJson)
        : "",
      ...
      proofData: isSet(object.proofData)
        ? bytesFromBase64(object.proofData)
        : new Uint8Array(0),
      toprf: isSet(object.toprf)
        ? TOPRFPayload.fromJSON(object.toprf)
        : undefined,
    }
  },
  ...
  toJSON(message: MessageReveal_ZKProof): unknown {
    ...
    if (message.decryptedRedactedCiphertext.length !== 0) {
      obj.decryptedRedactedCiphertext = base64FromBytes(
        message.decryptedRedactedCiphertext
      )
    }
    if (message.redactedPlaintext.length !== 0) {
  ...
  fromPartial(
    object: DeepPartial<MessageReveal_ZKProof>
  ): MessageReveal_ZKProof {
    const message = createBaseMessageReveal_ZKProof()
    message.proofJson = object.proofJson ?? ""
    message.decryptedRedactedCiphertext =
      object.decryptedRedactedCiphertext ?? new Uint8Array(0)
    ...
    message.toprf =
      object.toprf !== undefined && object.toprf !== null
...
export const TOPRFPayload: MessageFns<TOPRFPayload> = {
  ...
  fromJSON(object: any): TOPRFPayload {
    return {
      dataLocation: isSet(object.dataLocation)
        ? DataSlice.fromJSON(object.dataLocation)
        : undefined,
  ...
  fromPartial(object: DeepPartial<TOPRFPayload>): TOPRFPayload {
    ...
    message.dataLocation =
      object.dataLocation !== undefined && object.dataLocation !== null
        ? DataSlice.fromPartial(object.dataLocation)
        : undefined
    message.nullifier = object.nullifier ?? new Uint8Array(0)
    message.responses =
      object.responses?.map(e => TOPRFResponse.fromPartial(e)) || []
    return message
  },
}
...
export const ClaimTunnelRequest: MessageFns<ClaimTunnelRequest> = {
  encode(
    ...
    for (const v of message.transcript) {
      ClaimTunnelRequest_TranscriptMessage.encode(
        v!,
        writer.uint32(26).fork()
      ).join()
    }
    if (message.signatures !== undefined) {
      ClaimTunnelRequest_Signatures.encode(
        message.signatures,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.transcript.push(
            ClaimTunnelRequest_TranscriptMessage.decode(reader, reader.uint32())
          )
          continue
        }
        case 4: {
          ...
          message.signatures = ClaimTunnelRequest_Signatures.decode(
            reader,
            reader.uint32()
          )
          continue
  ...
  fromJSON(object: any): ClaimTunnelRequest {
    return {
      request: isSet(object.request)
        ? CreateTunnelRequest.fromJSON(object.request)
        : undefined,
      data: isSet(object.data)
        ? ClaimRequestData.fromJSON(object.data)
        : undefined,
      transcript: globalThis.Array.isArray(object?.transcript)
        ? object.transcript.map((e: any) =>
            ClaimTunnelRequest_TranscriptMessage.fromJSON(e)
          )
        : [],
      signatures: isSet(object.signatures)
        ? ClaimTunnelRequest_Signatures.fromJSON(object.signatures)
        : undefined,
      zkEngine: isSet(object.zkEngine)
        ? zKProofEngineFromJSON(object.zkEngine)
        : 0,
      fixedServerIV: isSet(object.fixedServerIV)
        ? bytesFromBase64(object.fixedServerIV)
        : new Uint8Array(0),
      fixedClientIV: isSet(object.fixedClientIV)
        ? bytesFromBase64(object.fixedClientIV)
        : new Uint8Array(0),
    }
  },
  ...
  toJSON(message: ClaimTunnelRequest): unknown {
    ...
    if (message.transcript?.length) {
      obj.transcript = message.transcript.map(e =>
        ClaimTunnelRequest_TranscriptMessage.toJSON(e)
      )
    }
    if (message.signatures !== undefined) {
  ...
  fromPartial(object: DeepPartial<ClaimTunnelRequest>): ClaimTunnelRequest {
    ...
    message.data =
      object.data !== undefined && object.data !== null
        ...
        : undefined
    message.transcript =
      object.transcript?.map(e =>
        ClaimTunnelRequest_TranscriptMessage.fromPartial(e)
      ) || []
    message.signatures =
      object.signatures !== undefined && object.signatures !== null
...
export const ClaimTunnelRequest_Signatures: MessageFns<ClaimTunnelRequest_Signatures> =
  {
    encode(
      message: ClaimTunnelRequest_Signatures,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
    ...
    fromJSON(object: any): ClaimTunnelRequest_Signatures {
      return {
        requestSignature: isSet(object.requestSignature)
          ? bytesFromBase64(object.requestSignature)
          : new Uint8Array(0),
      }
    },
    ...
    create(
      base?: DeepPartial<ClaimTunnelRequest_Signatures>
    ): ClaimTunnelRequest_Signatures {
      return ClaimTunnelRequest_Signatures.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<ClaimTunnelRequest_Signatures>
    ): ClaimTunnelRequest_Signatures {
      const message = createBaseClaimTunnelRequest_Signatures()
...
export const ClaimTunnelRequest_TranscriptMessage: MessageFns<ClaimTunnelRequest_TranscriptMessage> =
  {
    encode(
      message: ClaimTunnelRequest_TranscriptMessage,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      if (message.sender !== 0) {
    ...
    fromJSON(object: any): ClaimTunnelRequest_TranscriptMessage {
      return {
        sender: isSet(object.sender)
          ? transcriptMessageSenderTypeFromJSON(object.sender)
          : 0,
        message: isSet(object.message)
          ? bytesFromBase64(object.message)
          : new Uint8Array(0),
        reveal: isSet(object.reveal)
          ? MessageReveal.fromJSON(object.reveal)
          : undefined,
      }
    },
    ...
    create(
      base?: DeepPartial<ClaimTunnelRequest_TranscriptMessage>
    ): ClaimTunnelRequest_TranscriptMessage {
      return ClaimTunnelRequest_TranscriptMessage.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<ClaimTunnelRequest_TranscriptMessage>
    ): ClaimTunnelRequest_TranscriptMessage {
      const message = createBaseClaimTunnelRequest_TranscriptMessage()
...
export const ClaimTunnelResponse: MessageFns<ClaimTunnelResponse> = {
  encode(
    ...
    if (message.signatures !== undefined) {
      ClaimTunnelResponse_Signatures.encode(
        message.signatures,
        writer.uint32(34).fork()
      ).join()
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.signatures = ClaimTunnelResponse_Signatures.decode(
            reader,
            reader.uint32()
          )
          continue
  ...
  fromJSON(object: any): ClaimTunnelResponse {
    return {
      request: isSet(object.request)
        ? ClaimTunnelRequest.fromJSON(object.request)
        : undefined,
      claim: isSet(object.claim)
        ? ProviderClaimData.fromJSON(object.claim)
        : undefined,
      error: isSet(object.error) ? ErrorData.fromJSON(object.error) : undefined,
      signatures: isSet(object.signatures)
        ? ClaimTunnelResponse_Signatures.fromJSON(object.signatures)
        : undefined,
    }
  },
...
function createBaseClaimTunnelResponse_Signatures(): ClaimTunnelResponse_Signatures {
  return {
    ...
    resultSignature: new Uint8Array(0),
  }
}
...
export const ClaimTunnelResponse_Signatures: MessageFns<ClaimTunnelResponse_Signatures> =
  {
    encode(
      message: ClaimTunnelResponse_Signatures,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
    ...
    fromJSON(object: any): ClaimTunnelResponse_Signatures {
      return {
        attestorAddress: isSet(object.attestorAddress)
          ? globalThis.String(object.attestorAddress)
          : "",
        claimSignature: isSet(object.claimSignature)
          ? bytesFromBase64(object.claimSignature)
          : new Uint8Array(0),
        resultSignature: isSet(object.resultSignature)
          ? bytesFromBase64(object.resultSignature)
          : new Uint8Array(0),
      }
    },
    ...
    create(
      base?: DeepPartial<ClaimTunnelResponse_Signatures>
    ): ClaimTunnelResponse_Signatures {
      return ClaimTunnelResponse_Signatures.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<ClaimTunnelResponse_Signatures>
    ): ClaimTunnelResponse_Signatures {
      const message = createBaseClaimTunnelResponse_Signatures()
...
export const RequestClaimOnAvsRequest: MessageFns<RequestClaimOnAvsRequest> = {
  ...
  create(
    base?: DeepPartial<RequestClaimOnAvsRequest>
  ): RequestClaimOnAvsRequest {
    return RequestClaimOnAvsRequest.fromPartial(base ?? {})
  },
  fromPartial(
    object: DeepPartial<RequestClaimOnAvsRequest>
  ): RequestClaimOnAvsRequest {
    const message = createBaseRequestClaimOnAvsRequest()
...
export const RequestClaimOnAvsResponse: MessageFns<RequestClaimOnAvsResponse> =
  {
    ...
    fromJSON(object: any): RequestClaimOnAvsResponse {
      return {
        ...
        taskIndex: isSet(object.taskIndex)
          ? globalThis.Number(object.taskIndex)
          : 0,
        jsonTask: isSet(object.jsonTask)
          ? globalThis.String(object.jsonTask)
          : "",
      }
    },
    ...
    create(
      base?: DeepPartial<RequestClaimOnAvsResponse>
    ): RequestClaimOnAvsResponse {
      return RequestClaimOnAvsResponse.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<RequestClaimOnAvsResponse>
    ): RequestClaimOnAvsResponse {
      const message = createBaseRequestClaimOnAvsResponse()
...
export const CompleteClaimOnAvsRequest: MessageFns<CompleteClaimOnAvsRequest> =
  {
    ...
    fromJSON(object: any): CompleteClaimOnAvsRequest {
      return {
        ...
        taskIndex: isSet(object.taskIndex)
          ? globalThis.Number(object.taskIndex)
          : 0,
        completedTaskJson: isSet(object.completedTaskJson)
          ? globalThis.String(object.completedTaskJson)
          : "",
      }
    },
    ...
    create(
      base?: DeepPartial<CompleteClaimOnAvsRequest>
    ): CompleteClaimOnAvsRequest {
      return CompleteClaimOnAvsRequest.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<CompleteClaimOnAvsRequest>
    ): CompleteClaimOnAvsRequest {
      const message = createBaseCompleteClaimOnAvsRequest()
      message.chainId = object.chainId ?? 0
      message.taskIndex = object.taskIndex ?? 0
...
export const CompleteClaimOnAvsResponse: MessageFns<CompleteClaimOnAvsResponse> =
  {
    ...
    create(
      base?: DeepPartial<CompleteClaimOnAvsResponse>
    ): CompleteClaimOnAvsResponse {
      return CompleteClaimOnAvsResponse.fromPartial(base ?? {})
    },
    fromPartial(
      object: DeepPartial<CompleteClaimOnAvsResponse>
    ): CompleteClaimOnAvsResponse {
      const message = createBaseCompleteClaimOnAvsResponse()
      message.txHash = object.txHash ?? ""
  ...
  fromJSON(object: any): InitRequest {
    return {
      clientVersion: isSet(object.clientVersion)
        ? attestorVersionFromJSON(object.clientVersion)
        : 0,
      signatureType: isSet(object.signatureType)
        ? serviceSignatureTypeFromJSON(object.signatureType)
        : 0,
    }
  },
...
export const InitResponse: MessageFns<InitResponse> = {
  ...
  fromJSON(object: any): InitResponse {
    return {
      toprfPublicKey: isSet(object.toprfPublicKey)
        ? bytesFromBase64(object.toprfPublicKey)
        : new Uint8Array(0),
    }
  },
...
export const TOPRFRequest: MessageFns<TOPRFRequest> = {
  ...
  fromJSON(object: any): TOPRFRequest {
    return {
      maskedData: isSet(object.maskedData)
        ? bytesFromBase64(object.maskedData)
        : new Uint8Array(0),
...
export const TOPRFResponse: MessageFns<TOPRFResponse> = {
  ...
  fromJSON(object: any): TOPRFResponse {
    return {
      publicKeyShare: isSet(object.publicKeyShare)
        ? bytesFromBase64(object.publicKeyShare)
        : new Uint8Array(0),
      evaluated: isSet(object.evaluated)
        ? bytesFromBase64(object.evaluated)
        : new Uint8Array(0),
...
export const RPCMessage: MessageFns<RPCMessage> = {
  encode(
    ...
    if (message.disconnectTunnelRequest !== undefined) {
      DisconnectTunnelRequest.encode(
        message.disconnectTunnelRequest,
    ...
    if (message.tunnelMessage !== undefined) {
      TunnelMessage.encode(
        message.tunnelMessage,
        writer.uint32(82).fork()
      ).join()
    }
    if (message.tunnelDisconnectEvent !== undefined) {
      TunnelDisconnectEvent.encode(
        message.tunnelDisconnectEvent,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.connectionTerminationAlert = ErrorData.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 6: {
          ...
          message.createTunnelRequest = CreateTunnelRequest.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 8: {
          ...
          message.disconnectTunnelRequest = DisconnectTunnelRequest.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 9: {
          ...
          message.disconnectTunnelResponse = Empty.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 11: {
          ...
          message.tunnelDisconnectEvent = TunnelDisconnectEvent.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 12: {
          ...
          message.claimTunnelRequest = ClaimTunnelRequest.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 13: {
          ...
          message.claimTunnelResponse = ClaimTunnelResponse.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 14: {
          ...
          message.createClaimOnChainRequest = RequestClaimOnAvsRequest.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 15: {
          ...
          message.createClaimOnChainResponse = RequestClaimOnAvsResponse.decode(
            reader,
            reader.uint32()
          )
          continue
        ...
        case 16: {
          ...
          message.completeClaimOnChainRequest =
            CompleteClaimOnAvsRequest.decode(reader, reader.uint32())
          continue
        }
        case 17: {
          if (tag !== 138) {
          ...
          message.completeClaimOnChainResponse =
            CompleteClaimOnAvsResponse.decode(reader, reader.uint32())
          continue
        }
        case 18: {
          if (tag !== 146) {
  ...
  fromJSON(object: any): RPCMessage {
    return {
      id: isSet(object.id) ? globalThis.Number(object.id) : 0,
      initRequest: isSet(object.initRequest)
        ? InitRequest.fromJSON(object.initRequest)
        : undefined,
      initResponse: isSet(object.initResponse)
        ? InitResponse.fromJSON(object.initResponse)
        : undefined,
      connectionTerminationAlert: isSet(object.connectionTerminationAlert)
        ? ErrorData.fromJSON(object.connectionTerminationAlert)
        : undefined,
      requestError: isSet(object.requestError)
        ? ErrorData.fromJSON(object.requestError)
        : undefined,
      ...
      disconnectTunnelResponse: isSet(object.disconnectTunnelResponse)
        ...
        : undefined,
      tunnelMessage: isSet(object.tunnelMessage)
        ? TunnelMessage.fromJSON(object.tunnelMessage)
        : undefined,
      ...
      completeClaimOnChainResponse: isSet(object.completeClaimOnChainResponse)
        ? CompleteClaimOnAvsResponse.fromJSON(
            object.completeClaimOnChainResponse
          )
        : undefined,
      toprfRequest: isSet(object.toprfRequest)
        ? TOPRFRequest.fromJSON(object.toprfRequest)
        : undefined,
      toprfResponse: isSet(object.toprfResponse)
        ? TOPRFResponse.fromJSON(object.toprfResponse)
        : undefined,
    }
  },
  ...
  toJSON(message: RPCMessage): unknown {
    ...
    if (message.connectionTerminationAlert !== undefined) {
      obj.connectionTerminationAlert = ErrorData.toJSON(
        message.connectionTerminationAlert
      )
    }
    if (message.requestError !== undefined) {
    ...
    if (message.createTunnelRequest !== undefined) {
      obj.createTunnelRequest = CreateTunnelRequest.toJSON(
        message.createTunnelRequest
      )
    }
    if (message.createTunnelResponse !== undefined) {
    ...
    if (message.disconnectTunnelRequest !== undefined) {
      obj.disconnectTunnelRequest = DisconnectTunnelRequest.toJSON(
        message.disconnectTunnelRequest
      )
    }
    if (message.disconnectTunnelResponse !== undefined) {
      obj.disconnectTunnelResponse = Empty.toJSON(
        message.disconnectTunnelResponse
      )
    }
    if (message.tunnelMessage !== undefined) {
    ...
    if (message.tunnelDisconnectEvent !== undefined) {
      obj.tunnelDisconnectEvent = TunnelDisconnectEvent.toJSON(
        message.tunnelDisconnectEvent
      )
    }
    if (message.claimTunnelRequest !== undefined) {
      obj.claimTunnelRequest = ClaimTunnelRequest.toJSON(
        message.claimTunnelRequest
      )
    }
    if (message.claimTunnelResponse !== undefined) {
      obj.claimTunnelResponse = ClaimTunnelResponse.toJSON(
        message.claimTunnelResponse
      )
    }
    if (message.createClaimOnChainRequest !== undefined) {
      obj.createClaimOnChainRequest = RequestClaimOnAvsRequest.toJSON(
        message.createClaimOnChainRequest
      )
    }
    if (message.createClaimOnChainResponse !== undefined) {
      obj.createClaimOnChainResponse = RequestClaimOnAvsResponse.toJSON(
        message.createClaimOnChainResponse
      )
    }
    if (message.completeClaimOnChainRequest !== undefined) {
      obj.completeClaimOnChainRequest = CompleteClaimOnAvsRequest.toJSON(
        message.completeClaimOnChainRequest
      )
    }
    if (message.completeClaimOnChainResponse !== undefined) {
      obj.completeClaimOnChainResponse = CompleteClaimOnAvsResponse.toJSON(
        message.completeClaimOnChainResponse
      )
    }
    if (message.toprfRequest !== undefined) {
  ...
  fromPartial(object: DeepPartial<RPCMessage>): RPCMessage {
    ...
    message.id = object.id ?? 0
    message.initRequest =
      object.initRequest !== undefined && object.initRequest !== null
        ? InitRequest.fromPartial(object.initRequest)
        : undefined
    message.initResponse =
      object.initResponse !== undefined && object.initResponse !== null
        ? InitResponse.fromPartial(object.initResponse)
        : undefined
    message.connectionTerminationAlert =
      object.connectionTerminationAlert !== undefined &&
      object.connectionTerminationAlert !== null
        ? ErrorData.fromPartial(object.connectionTerminationAlert)
        : undefined
    message.requestError =
      object.requestError !== undefined && object.requestError !== null
        ? ErrorData.fromPartial(object.requestError)
        : undefined
    message.createTunnelRequest =
      object.createTunnelRequest !== undefined &&
      object.createTunnelRequest !== null
        ? CreateTunnelRequest.fromPartial(object.createTunnelRequest)
        : undefined
    message.createTunnelResponse =
      object.createTunnelResponse !== undefined &&
      object.createTunnelResponse !== null
        ? Empty.fromPartial(object.createTunnelResponse)
        : undefined
    message.disconnectTunnelRequest =
      object.disconnectTunnelRequest !== undefined &&
      object.disconnectTunnelRequest !== null
        ? DisconnectTunnelRequest.fromPartial(object.disconnectTunnelRequest)
        : undefined
    message.disconnectTunnelResponse =
      object.disconnectTunnelResponse !== undefined &&
      object.disconnectTunnelResponse !== null
        ? Empty.fromPartial(object.disconnectTunnelResponse)
        : undefined
    message.tunnelMessage =
      object.tunnelMessage !== undefined && object.tunnelMessage !== null
        ? TunnelMessage.fromPartial(object.tunnelMessage)
        : undefined
    message.tunnelDisconnectEvent =
      object.tunnelDisconnectEvent !== undefined &&
      object.tunnelDisconnectEvent !== null
        ? TunnelDisconnectEvent.fromPartial(object.tunnelDisconnectEvent)
        : undefined
    message.claimTunnelRequest =
      object.claimTunnelRequest !== undefined &&
      object.claimTunnelRequest !== null
        ? ClaimTunnelRequest.fromPartial(object.claimTunnelRequest)
        : undefined
    message.claimTunnelResponse =
      object.claimTunnelResponse !== undefined &&
      object.claimTunnelResponse !== null
        ? ClaimTunnelResponse.fromPartial(object.claimTunnelResponse)
        : undefined
    message.createClaimOnChainRequest =
      object.createClaimOnChainRequest !== undefined &&
      object.createClaimOnChainRequest !== null
        ? RequestClaimOnAvsRequest.fromPartial(object.createClaimOnChainRequest)
        : undefined
    message.createClaimOnChainResponse =
      object.createClaimOnChainResponse !== undefined &&
      object.createClaimOnChainResponse !== null
        ? RequestClaimOnAvsResponse.fromPartial(
            object.createClaimOnChainResponse
          )
        : undefined
    message.completeClaimOnChainRequest =
      object.completeClaimOnChainRequest !== undefined &&
      object.completeClaimOnChainRequest !== null
        ? CompleteClaimOnAvsRequest.fromPartial(
            object.completeClaimOnChainRequest
          )
        : undefined
    message.completeClaimOnChainResponse =
      object.completeClaimOnChainResponse !== undefined &&
      object.completeClaimOnChainResponse !== null
        ? CompleteClaimOnAvsResponse.fromPartial(
            object.completeClaimOnChainResponse
          )
        : undefined
    message.toprfRequest =
      object.toprfRequest !== undefined && object.toprfRequest !== null
        ? TOPRFRequest.fromPartial(object.toprfRequest)
        : undefined
    message.toprfResponse =
      object.toprfResponse !== undefined && object.toprfResponse !== null
...
export const RPCMessages: MessageFns<RPCMessages> = {
  ...
  fromPartial(object: DeepPartial<RPCMessages>): RPCMessages {
    const message = createBaseRPCMessages()
    message.messages =
      object.messages?.map(e => RPCMessage.fromPartial(e)) || []
    return message
  },
}
